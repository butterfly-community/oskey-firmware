...
#define MSOS2_VENDOR_CODE     0x02U
/* Windows version (10)*/
#define MSOS2_WINDOWS_VERSION 0x0A000000UL

/* random GUID {FA611CC3-7057-42EE-9D82-4919639562B3} */
#define WEBUSB_DEVICE_INTERFACE_GUID                                                               \
	'{', 0x00, 'F', 0x00, 'A', 0x00, '6', 0x00, '1', 0x00, '1', 0x00, 'C', 0x00, 'C', 0x00,    \
		'3', 0x00, '-', 0x00, '7', 0x00, '0', 0x00, '5', 0x00, '7', 0x00, '-', 0x00, '4',  \
		0x00, '2', 0x00, 'E', 0x00, 'E', 0x00, '-', 0x00, '9', 0x00, 'D', 0x00, '8', 0x00, \
		'2', 0x00, '-', 0x00, '4', 0x00, '9', 0x00, '1', 0x00, '9', 0x00, '6', 0x00, '3',  \
		0x00, '9', 0x00, '5', 0x00, '6', 0x00, '2', 0x00, 'B', 0x00, '3', 0x00, '}', 0x00, \
		0x00, 0x00, 0x00, 0x00

#define MSOS2_FUNCTION_SUBSET_LENGTH                                                               \
...
struct msosv2_descriptor {
	 ...
	 * interface number assigned by the USB stack before the descriptor is
	 * sent to the host.
	 */
...
struct bos_msosv2_descriptor bos_msosv2_desc = {
	...
	.cap = {.dwWindowsVersion = sys_cpu_to_le32(MSOS2_WINDOWS_VERSION),
		.wMSOSDescriptorSetTotalLength = sys_cpu_to_le16(sizeof(msosv2_desc)),
		.bMS_VendorCode = MSOS2_VENDOR_CODE,
		.bAltEnumCode = 0x00},
};
...
USBD_DESC_BOS_VREQ_DEFINE(bos_vreq_msosv2, sizeof(bos_msosv2_desc), &bos_msosv2_desc,
			  MSOS2_VENDOR_CODE, msosv2_to_host_cb, NULL);
